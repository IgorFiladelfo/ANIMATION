...
const setSymmetricWall = (x, y, direction, sym, lineId) => {
    if (direction == 'horizontal') {
        (0, constants_1.setWall)(x, y, 'horizontal', lineId);
        if (sym == 'x') {
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x - 1, y, 'horizontal', lineId);
        }
        else if (sym == 'y') {
            (0, constants_1.setWall)(x, constants_1.GRID_HEIGHT - y, 'horizontal', lineId);
        }
        else if (sym == 'xy') {
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x - 1, y, 'horizontal', lineId);
            (0, constants_1.setWall)(x, constants_1.GRID_HEIGHT - y, 'horizontal', lineId);
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x - 1, constants_1.GRID_HEIGHT - y, 'horizontal', lineId);
        }
    }
    else {
        (0, constants_1.setWall)(x, y, 'vertical', lineId);
        if (sym == 'x') {
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x, y, 'vertical', lineId);
        }
        else if (sym == 'y') {
            (0, constants_1.setWall)(x, constants_1.GRID_HEIGHT - y - 1, 'vertical', lineId);
        }
        else if (sym == 'xy') {
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x, y, 'vertical', lineId);
            (0, constants_1.setWall)(x, constants_1.GRID_HEIGHT - y - 1, 'vertical', lineId);
            (0, constants_1.setWall)(constants_1.GRID_WIDTH - x, constants_1.GRID_HEIGHT - y - 1, 'vertical', lineId);
        }
    }
};
const buildWalls = () => {
    ...
    // Ghost House
    (0, constants_1.setWall)(25, 2, 'horizontal', 'GH_TOP');
    (0, constants_1.setWall)(27, 2, 'horizontal', 'GH_TOP');
    (0, constants_1.setWall)(25, 4, 'horizontal', 'GH_BOTTOM');
    (0, constants_1.setWall)(26, 4, 'horizontal', 'GH_BOTTOM');
    (0, constants_1.setWall)(27, 4, 'horizontal', 'GH_BOTTOM');
    (0, constants_1.setWall)(25, 3, 'vertical', 'GH_LEFT');
    (0, constants_1.setWall)(28, 3, 'vertical', 'GH_RIGHT');
    (0, constants_1.setWall)(25, 2, 'vertical', 'GH_LEFT');
    (0, constants_1.setWall)(28, 2, 'vertical', 'GH_RIGHT');
};
exports.Grid = {
    buildWalls
};
